    ...
    <div class="wrap wrap_why_us">
        <strong class="heading">
            <? $APPLICATION->IncludeComponent(
            	...
            	Array(
            		"AREA_FILE_SHOW" => "file",
            		"PATH" => v::includedArea('homepage/why_us_heading.php')
            	)
            ); ?>
        </strong>
        <? $APPLICATION->IncludeComponent(
    ...
    <div class="wrap">
        <strong class="heading">
            <? $APPLICATION->IncludeComponent(
            	...
            	Array(
            		"AREA_FILE_SHOW" => "file",
            		"PATH" => v::includedArea('homepage/promotions_heading.php')
            	)
            ); ?>
        </strong>
        <? $APPLICATION->IncludeComponent(
...
<section class="gallery">
    <strong class="heading">
        <? $APPLICATION->IncludeComponent(
        	...
        	Array(
        		"AREA_FILE_SHOW" => "file",
        		"PATH" => v::includedArea('homepage/gallery_heading.php')
        	)
        ); ?>
    </strong>
    <? $APPLICATION->IncludeComponent(
    	...
    	Array(
    		...
    		"FILTER_NAME" => "",
    		"HIDE_LINK_WHEN_NO_DETAIL" => "N",
    		"IBLOCK_ID" => IblockTools::find(Iblock::CONTENT_TYPE, Iblock::GALLERY)->id(),
    		"IBLOCK_TYPE" => Iblock::CONTENT_TYPE,
    		"INCLUDE_IBLOCK_INTO_CHAIN" => "N",
    		"INCLUDE_SUBSECTIONS" => "Y",
    		"MESSAGE_404" => "",
